  ...
  return (
    <div className="flex flex-col min-h-screen lg:min-h-0 bg-bg lg:rounded-2xl lg:overflow-hidden lg:border lg:border-border lg:shadow-sm">
      ...
      <div className="flex flex-col items-center justify-center flex-1 px-6 text-center">
        ...
        <h3 className="text-base font-bold text-primary mb-2">Style Inspiration</h3>
        <p className="text-sm text-muted">Save outfit inspiration and wishlist images. Coming in Phase 2.</p>
      </div>
    </div>
  );
}
